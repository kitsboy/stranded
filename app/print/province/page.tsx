...
function ProvincePrintContent() {
  ...
  if (loading) {
    return <div className="p-12 text-center text-gray-400">Preparing printable one-pager…</div>
  }
  ...
  if (!provinceName || !provinceSites.length) {
    return (
      <div className="p-12 text-center">
        ...
        <p className="text-xs text-gray-400 mt-2">Example: /print/province?province=Alberta</p>
      </div>
    )
  }

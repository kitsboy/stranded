...
export default function EcccFreshnessBadge({ stats, className = '' }: EcccFreshnessBadgeProps) {
  ...
  return (
    ...
    >
      <div className="glass text-label px-3 py-1.5 rounded-xl border border-[#5BC0BE]/30 text-gray-300 shadow-lg leading-snug pointer-events-auto flex items-center gap-2">
